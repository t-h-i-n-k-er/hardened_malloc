...
ifeq (,$(filter $(CONFIG_ADAPTIVE_QUARANTINE),true false))
    $(error CONFIG_ADAPTIVE_QUARANTINE must be true or false)
endif

ifeq (,$(filter $(CONFIG_MTE_DETERMINISTIC_UAF),true false))
    $(error CONFIG_MTE_DETERMINISTIC_UAF must be true or false)
endif
...
CPPFLAGS += \
    ...
    -DCONFIG_ADAPTIVE_QUARANTINE=$(CONFIG_ADAPTIVE_QUARANTINE) \
    -DCONFIG_QUARANTINE_MIN_SCALE=$(CONFIG_QUARANTINE_MIN_SCALE) \
    -DCONFIG_MTE_DETERMINISTIC_UAF=$(CONFIG_MTE_DETERMINISTIC_UAF)
